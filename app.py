...
@st.cache_data
def load_data():
    df_transport = pd.read_csv("data/Transportation data_test.csv")
    df_customer = pd.read_excel("data/Customer Group_Test.xlsx")
...
def get_data_summary():
    ...
    risk_df = pd.read_csv(
        "/Users/mina/Documents/SUPPLY CHAIN ANALYST/Exports/risk_scores.csv"
    )
    risk_data = risk_df[[
    ...
    forecast_df = pd.read_csv(
        "/Users/mina/Documents/SUPPLY CHAIN ANALYST/Exports/forecast_uncovered.csv"
    )
